...
public class Self_FormItemCompare extends Base_Page {
	
	@FindBy(xpath="//p[contains(text(),'Please rate the extent to which you display each behavior.')]")
	private WebElement behaviours;
	
	@FindBy(xpath="//div[contains(text(),'Choose only five.')]")
	private WebElement importance;
	
	@FindBy(xpath="//div[contains(text(),'They will not be reviewed or edited.')]")
	...
	@FindBy(xpath="//span[contains(text(),'What are some of the ways in which you have displa')]")
	private WebElement wc;
	
	@FindBy(xpath="//span[contains(text(),'Review')]")
	private WebElement reveiw;
	
	
	

	public Self_FormItemCompare(WebDriver driver) {
		super(driver);
	...
	public void compare_form_items_and_InstText() {
		...
		String expected61 = Excel.getdata("Self_instText", 1, 0);
		String actual61 = behaviours.getText();
		...
		if(actual8.equalsIgnoreCase(expected8)) {
			...
			Excel.wite_data("Sheet2", 8, 1, "Pass");
		}else {
			System.out.println("item8 is not matching");
			Excel.wite_data("Sheet2", 8, 1, "fail");
		}
		
		verifyElement(30, item9);
		String expected9 = Excel.getdata("Sheet2", 9, 0);
		...
		if(actual9.equalsIgnoreCase(expected9)) {
			...
			Excel.wite_data("Sheet2", 9, 1, "Pass");
		}else {
			System.out.println("item9 is not matching");
			Excel.wite_data("Sheet2", 9, 1, "fail");
		}
		
		verifyElement(30, item10);
		String expected10 = Excel.getdata("Sheet2", 10, 0);
		...
		if(actual10.equalsIgnoreCase(expected10)) {
			...
			Excel.wite_data("Sheet2", 10, 1, "Pass");
		}else {
			System.out.println("item10 is not matching");
			Excel.wite_data("Sheet2", 10, 1, "fail");
		}
		
		verifyElement(30, item11);
		String expected11 = Excel.getdata("Sheet2", 11, 0);
		...
		if(actual11.equalsIgnoreCase(expected11)) {
			...
			Excel.wite_data("Sheet2", 11, 1, "Pass");
		}else {
			System.out.println("item11 is not matching");
			Excel.wite_data("Sheet2", 11, 1, "fail");
		}
		
		verifyElement(30, item12);
		String expected12 = Excel.getdata("Sheet2", 12, 0);
		...
		if(actual12.equalsIgnoreCase(expected12)) {
			...
			Excel.wite_data("Sheet2", 12, 1, "Pass");
		}else {
			System.out.println("item12 is not matching");
			Excel.wite_data("Sheet2", 12, 1, "fail");
		}
		
		verifyElement(30, item13);
		String expected13 = Excel.getdata("Sheet2", 13, 0);
		...
		if(actual13.equalsIgnoreCase(expected13)) {
			...
			Excel.wite_data("Sheet2", 13, 1, "Pass");
		}else {
			System.out.println("item13 is not matching");
			Excel.wite_data("Sheet2", 13, 1, "fail");
		}
		
		verifyElement(30, item14);
		String expected14 = Excel.getdata("Sheet2", 14, 0);
		...
		if(actual14.equalsIgnoreCase(expected14)) {
			...
			Excel.wite_data("Sheet2", 14, 1, "Pass");
		}else {
			System.out.println("item14 is not matching");
			Excel.wite_data("Sheet2", 14, 1, "fail");
		}
		
		verifyElement(30, item15);
		String expected15 = Excel.getdata("Sheet2", 15, 0);
		...
		if(actual15.equalsIgnoreCase(expected15)) {
			...
			Excel.wite_data("Sheet2", 15, 1, "Pass");
		}else {
			System.out.println("item15 is not matching");
			Excel.wite_data("Sheet2", 15, 1, "fail");
		}
		
		verifyElement(30, item16);
		String expected16 = Excel.getdata("Sheet2", 16, 0);
		...
		if(actual16.equalsIgnoreCase(expected16)) {
			...
			Excel.wite_data("Sheet2", 16, 1, "Pass");
		}else {
			System.out.println("item16 is not matching");
			Excel.wite_data("Sheet2", 16, 1, "fail");
		}
		...
		String expected17 = Excel.getdata("Sheet2", 17, 0);
		...
		if(actual17.equalsIgnoreCase(expected17)) {
			...
			Excel.wite_data("Sheet2", 17, 1, "Pass");
		}else {
			System.out.println("item17 is not matching");
			Excel.wite_data("Sheet2", 17, 1, "fail");
		}
		
		verifyElement(30, item18);
		String expected18 = Excel.getdata("Sheet2", 18, 0);
		...
		if(actual18.equalsIgnoreCase(expected18)) {
			...
			Excel.wite_data("Sheet2", 18, 1, "Pass");
		}else {
			System.out.println("item18 is not matching");
			Excel.wite_data("Sheet2", 18, 1, "fail");
		}
		
		verifyElement(30, item19);
		String expected19 = Excel.getdata("Sheet2", 19, 0);
		...
		if(actual19.equalsIgnoreCase(expected19)) {
			...
			Excel.wite_data("Sheet2", 19, 1, "Pass");
		}else {
			System.out.println("item19 is not matching");
			Excel.wite_data("Sheet2", 19, 1, "fail");
		}
		
		verifyElement(30, item20);
		String expected20 = Excel.getdata("Sheet2", 20, 0);
		...
		if(actual20.equalsIgnoreCase(expected20)) {
			...
			Excel.wite_data("Sheet2", 20, 1, "Pass");
		}else {
			System.out.println("item20 is not matching");
			Excel.wite_data("Sheet2", 20, 1, "fail");
		}
		
		verifyElement(30, item21);
		String expected21 = Excel.getdata("Sheet2", 21, 0);
		...
		if(actual21.equalsIgnoreCase(expected21)) {
			...
			Excel.wite_data("Sheet2", 21, 1, "Pass");
		}else {
			System.out.println("item21 is not matching");
			Excel.wite_data("Sheet2", 21, 1, "fail");
		}
		
		verifyElement(30, item22);
		String expected22 = Excel.getdata("Sheet2", 22, 0);
		...
		if(actual22.equalsIgnoreCase(expected22)) {
			...
			Excel.wite_data("Sheet2", 22, 1, "Pass");
		}else {
			System.out.println("item22 is not matching");
			Excel.wite_data("Sheet2", 22, 1, "fail");
		}
		
		verifyElement(30, item23);
		String expected23 = Excel.getdata("Sheet2", 23, 0);
		...
		if(actual23.equalsIgnoreCase(expected23)) {
			...
			Excel.wite_data("Sheet2", 23, 1, "Pass");
		}else {
			System.out.println("item23 is not matching");
			Excel.wite_data("Sheet2", 23, 1, "fail");
		}
		
		verifyElement(30, item24);
		String expected24 = Excel.getdata("Sheet2", 24, 0);
		...
		if(actual24.equalsIgnoreCase(expected24)) {
			...
			Excel.wite_data("Sheet2", 24, 1, "Pass");
		}else {
			System.out.println("item24 is not matching");
			Excel.wite_data("Sheet2", 24, 1, "fail");
		}
		
		verifyElement(30, item25);
		String expected25 = Excel.getdata("Sheet2", 25, 0);
		...
		if(actual25.equalsIgnoreCase(expected25)) {
			...
			Excel.wite_data("Sheet2", 25, 1, "Pass");
		}else {
			System.out.println("item25 is not matching");
			Excel.wite_data("Sheet2", 25, 1, "fail");
		}
		
		verifyElement(30, item26);
		String expected26 = Excel.getdata("Sheet2", 26, 0);
		...
		if(actual26.equalsIgnoreCase(expected26)) {
			...
			Excel.wite_data("Sheet2", 26, 1, "Pass");
		}else {
			System.out.println("item26 is not matching");
			Excel.wite_data("Sheet2", 26, 1, "fail");
		}
		
		verifyElement(30, item27);
		String expected27 = Excel.getdata("Sheet2", 27, 0);
		...
		if(actual27.equalsIgnoreCase(expected27)) {
			...
			Excel.wite_data("Sheet2", 27, 1, "Pass");
		}else {
			System.out.println("item27 is not matching");
			Excel.wite_data("Sheet2", 27, 1, "fail");
		}
		
		verifyElement(30, item28);
		String expected28 = Excel.getdata("Sheet2", 28, 0);
		...
		if(actual28.equalsIgnoreCase(expected28)) {
			...
			Excel.wite_data("Sheet2", 28, 1, "Pass");
		}else {
			System.out.println("item28 is not matching");
			Excel.wite_data("Sheet2", 28, 1, "fail");
		}
		
		verifyElement(30, item29);
		String expected29 = Excel.getdata("Sheet2", 29, 0);
		...
		if(actual29.equalsIgnoreCase(expected29)) {
			...
			Excel.wite_data("Sheet2", 29, 1, "Pass");
		}else {
			System.out.println("item29 is not matching");
			Excel.wite_data("Sheet2", 29, 1, "fail");
		}
		
		verifyElement(30, item30);
		String expected30 = Excel.getdata("Sheet2", 30, 0);
		...
		if(actual30.equalsIgnoreCase(expected30)) {
			...
			Excel.wite_data("Sheet2", 30, 1, "Pass");
		}else {
			System.out.println("item30 is not matching");
			Excel.wite_data("Sheet2", 30, 1, "fail");
		}
		
		verifyElement(30, item31);
		String expected31 = Excel.getdata("Sheet2", 31, 0);
		...
		if(actual31.equalsIgnoreCase(expected31)) {
			...
			Excel.wite_data("Sheet2", 31, 1, "Pass");
		}else {
			System.out.println("item31 is not matching");
			Excel.wite_data("Sheet2", 31, 1, "fail");
		}
		
		verifyElement(30, item32);
		String expected32 = Excel.getdata("Sheet2", 32, 0);
		...
		if(actual32.equalsIgnoreCase(expected32)) {
			...
			Excel.wite_data("Sheet2", 32, 1, "Pass");
		}else {
			System.out.println("item32 is not matching");
			Excel.wite_data("Sheet2", 32, 1, "fail");
		}
		...
		String expected33 = Excel.getdata("Sheet2", 33, 0);
		...
		if(actual33.equalsIgnoreCase(expected33)) {
			...
			Excel.wite_data("Sheet2", 33, 1, "Pass");
		}else {
			System.out.println("item33 is not matching");
			Excel.wite_data("Sheet2", 33, 1, "fail");
		}
		
		verifyElement(30, item34);
		String expected34 = Excel.getdata("Sheet2", 34, 0);
		...
		if(actual34.equalsIgnoreCase(expected34)) {
			...
			Excel.wite_data("Sheet2", 34, 1, "Pass");
		}else {
			System.out.println("item34 is not matching");
			Excel.wite_data("Sheet2", 34, 1, "fail");
		}
		
		verifyElement(30, item35);
		String expected35 = Excel.getdata("Sheet2", 35, 0);
		...
		if(actual35.equalsIgnoreCase(expected35)) {
			...
			Excel.wite_data("Sheet2", 35, 1, "Pass");
		}else {
			System.out.println("item35 is not matching");
			Excel.wite_data("Sheet2", 35, 1, "fail");
		}
		
		verifyElement(30, item36);
		String expected36 = Excel.getdata("Sheet2", 36, 0);
		...
		if(actual36.equalsIgnoreCase(expected36)) {
			...
			Excel.wite_data("Sheet2", 36, 1, "Pass");
		}else {
			System.out.println("item36 is not matching");
			Excel.wite_data("Sheet2", 36, 1, "fail");
		}
		
		verifyElement(30, item37);
		String expected37 = Excel.getdata("Sheet2", 37, 0);
		...
		if(actual37.equalsIgnoreCase(expected37)) {
			...
			Excel.wite_data("Sheet2", 37, 1, "Pass");
		}else {
			System.out.println("item37 is not matching");
			Excel.wite_data("Sheet2", 37, 1, "fail");
		}
		
		verifyElement(30, item38);
		String expected38 = Excel.getdata("Sheet2", 38, 0);
		...
		if(actual38.equalsIgnoreCase(expected38)) {
			...
			Excel.wite_data("Sheet2", 38, 1, "Pass");
		}else {
			System.out.println("item38 is not matching");
			Excel.wite_data("Sheet2", 38, 1, "fail");
		}
		
		verifyElement(30, item39);
		String expected39 = Excel.getdata("Sheet2", 39, 0);
		...
		if(actual39.equalsIgnoreCase(expected39)) {
			...
			Excel.wite_data("Sheet2", 39, 1, "Pass");
		}else {
			System.out.println("item39 is not matching");
			Excel.wite_data("Sheet2", 39, 1, "fail");
		}
		
		verifyElement(30, item40);
		String expected40 = Excel.getdata("Sheet2", 40, 0);
		...
		if(actual40.equalsIgnoreCase(expected40)) {
			...
			Excel.wite_data("Sheet2", 40, 1, "Pass");
		}else {
			System.out.println("item40 is not matching");
			Excel.wite_data("Sheet2", 40, 1, "fail");
		}
		
		verifyElement(30, item41);
		String expected41 = Excel.getdata("Sheet2", 41, 0);
		...
		if(actual41.equalsIgnoreCase(expected41)) {
			...
			Excel.wite_data("Sheet2", 41, 1, "Pass");
		}else {
			System.out.println("item41 is not matching");
			Excel.wite_data("Sheet2", 41, 1, "fail");
		}
		
		verifyElement(30, item42);
		String expected42 = Excel.getdata("Sheet2", 42, 0);
		...
		if(actual42.equalsIgnoreCase(expected42)) {
			...
			Excel.wite_data("Sheet2", 42, 1, "Pass");
		}else {
			System.out.println("item42 is not matching");
			Excel.wite_data("Sheet2", 42, 1, "fail");
		}
		
		verifyElement(30, item43);
		String expected43 = Excel.getdata("Sheet2", 43, 0);
		...
		if(actual43.equalsIgnoreCase(expected43)) {
			...
			Excel.wite_data("Sheet2", 43, 1, "Pass");
		}else {
			System.out.println("item43 is not matching");
			Excel.wite_data("Sheet2", 43, 1, "fail");
		}
		
		verifyElement(30, item44);
		String expected44 = Excel.getdata("Sheet2", 44, 0);
		...
		if(actual44.equalsIgnoreCase(expected44)) {
			...
			Excel.wite_data("Sheet2", 44, 1, "Pass");
		}else {
			System.out.println("item44 is not matching");
			Excel.wite_data("Sheet2", 44, 1, "fail");
		}
		
		verifyElement(30, item45);
		String expected45 = Excel.getdata("Sheet2", 45, 0);
		...
		if(actual45.equalsIgnoreCase(expected45)) {
			...
			Excel.wite_data("Sheet2", 45, 1, "Pass");
		}else {
			System.out.println("item45 is not matching");
			Excel.wite_data("Sheet2", 45, 1, "fail");
		}
		
		verifyElement(30, item46);
		String expected46 = Excel.getdata("Sheet2", 46, 0);
		...
		if(actual46.equalsIgnoreCase(expected46)) {
			...
			Excel.wite_data("Sheet2", 46, 1, "Pass");
		}else {
			System.out.println("item46 is not matching");
			Excel.wite_data("Sheet2", 46, 1, "fail");
		}
		
		verifyElement(30, item47);
		String expected47 = Excel.getdata("Sheet2", 47, 0);
		...
		if(actual47.equalsIgnoreCase(expected47)) {
			...
			Excel.wite_data("Sheet2", 47, 1, "Pass");
		}else {
			System.out.println("item47 is not matching");
			Excel.wite_data("Sheet2", 47, 1, "fail");
		}
		
		verifyElement(30, item48);
		String expected48 = Excel.getdata("Sheet2", 48, 0);
		...
		if(actual48.equalsIgnoreCase(expected48)) {
			...
			Excel.wite_data("Sheet2", 48, 1, "Pass");
		}else {
			System.out.println("item48 is not matching");
			Excel.wite_data("Sheet2", 48, 1, "fail");
		}
		...
		String expected62 = Excel.getdata("Self_instText", 2, 0);
		String actual62 = importance.getText();
		...
		if(actual62.equalsIgnoreCase(expected62)) {
			...
			Excel.wite_data("Self_instText", 2, 1, "Pass");
		}else {
			System.out.println("importance instruction is  matching");
			Excel.wite_data("Self_instText", 2, 1, "pass");
		}
		
		verifyElement(60, imp1);
		String expected49 = Excel.getdata("ImpForSuc", 1, 0);
		...
		if(actual49.equalsIgnoreCase(expected49)) {
			...
			Excel.wite_data("ImpForSuc", 1, 1, "Pass");
		}else {
			System.out.println("imp1 is not matching");
			Excel.wite_data("ImpForSuc", 1, 1, "fail");
		}
		
		verifyElement(60, imp2);
		String expected50 = Excel.getdata("ImpForSuc", 2, 0);
		...
		if(actual50.equalsIgnoreCase(expected50)) {
			...
			Excel.wite_data("ImpForSuc", 2, 1, "Pass");
		}else {
			System.out.println("imp2 is not matching");
			Excel.wite_data("ImpForSuc", 2, 1, "fail");
		}
		
		verifyElement(60, imp3);
		String expected51 = Excel.getdata("ImpForSuc", 3, 0);
		...
		if(actual51.equalsIgnoreCase(expected51)) {
			...
			Excel.wite_data("ImpForSuc", 3, 1, "Pass");
		}else {
			System.out.println("imp3 is not matching");
			Excel.wite_data("ImpForSuc", 3, 1, "fail");
		}
		
		verifyElement(60, imp4);
		String expected52 = Excel.getdata("ImpForSuc", 4, 0);
		...
		if(actual52.equalsIgnoreCase(expected52)) {
			...
			Excel.wite_data("ImpForSuc", 4, 1, "Pass");
		}else {
			System.out.println("imp4 is not matching");
			Excel.wite_data("ImpForSuc", 4, 1, "fail");
		}
		
		verifyElement(60, imp5);
		String expected53 = Excel.getdata("ImpForSuc", 5, 0);
		...
		if(actual53.equalsIgnoreCase(expected53)) {
			...
			Excel.wite_data("ImpForSuc", 5, 1, "Pass");
		}else {
			System.out.println("imp5 is not matching");
			Excel.wite_data("ImpForSuc", 5, 1, "fail");
		}
		
		verifyElement(60, imp6);
		String expected54 = Excel.getdata("ImpForSuc", 6, 0);
		...
		if(actual54.equalsIgnoreCase(expected54)) {
			...
			Excel.wite_data("ImpForSuc", 6, 1, "Pass");
		}else {
			System.out.println("imp6 is not matching");
			Excel.wite_data("ImpForSuc", 6, 1, "fail");
		}
		
		verifyElement(60, imp7);
		String expected55 = Excel.getdata("ImpForSuc", 7, 0);
		...
		if(actual55.equalsIgnoreCase(expected55)) {
			...
			Excel.wite_data("ImpForSuc", 7, 1, "Pass");
		}else {
			System.out.println("imp7 is not matching");
			Excel.wite_data("ImpForSuc", 7, 1, "fail");
		}
		
		verifyElement(60, imp8);
		String expected56 = Excel.getdata("ImpForSuc", 8, 0);
		...
		if(actual56.equalsIgnoreCase(expected56)) {
			...
			Excel.wite_data("ImpForSuc", 8, 1, "Pass");
		}else {
			System.out.println("imp8 is not matching");
			Excel.wite_data("ImpForSuc", 8, 1, "fail");
		}
		
		verifyElement(60, imp9);
		String expected57 = Excel.getdata("ImpForSuc", 9, 0);
		...
		if(actual57.equalsIgnoreCase(expected57)) {
			...
			Excel.wite_data("ImpForSuc", 9, 1, "Pass");
		}else {
			System.out.println("imp9 is not matching");
			Excel.wite_data("ImpForSuc", 9, 1, "fail");
		}
		
		verifyElement(60, imp10);
		String expected58 = Excel.getdata("ImpForSuc", 10, 0);
		...
		if(actual58.equalsIgnoreCase(expected58)) {
			...
			Excel.wite_data("ImpForSuc", 10, 1, "Pass");
		}else {
			System.out.println("imp10 is not matching");
			Excel.wite_data("ImpForSuc", 10, 1, "fail");
		}
		
		verifyElement(60, imp11);
		String expected59 = Excel.getdata("ImpForSuc", 11, 0);
		...
		if(actual59.equalsIgnoreCase(expected59)) {
			...
			Excel.wite_data("ImpForSuc", 11, 1, "Pass");
		}else {
			System.out.println("imp11 is not matching");
			Excel.wite_data("ImpForSuc", 11, 1, "fail");
		}
		...
		String expected63 = Excel.getdata("Self_instText", 3, 0);
		String actual63 = written_comments.getText();
		...
		if(actual63.equalsIgnoreCase(expected63)) {
			...
			Excel.wite_data("Self_instText", 3, 1, "Pass");
		}else {
			System.out.println("written_comments instruction is not matching");
			Excel.wite_data("Self_instText", 3, 1, "fail");
		}
		
		verifyElement(60, wc);
		String expected60 = Excel.getdata("Written_comments", 1, 0);
		...
		if(actual60.equalsIgnoreCase(expected60)) {
			...
			Excel.wite_data("Written_comments", 1, 1, "Pass");
		}else {
			System.out.println("Written comments  is  matching");
			Excel.wite_data("Written_comments", 1, 1, "Pass");
		}
		
		verifyElement(60, reveiw);
		reveiw.click();
		
		verifyElement(60, yourResponse);
		String expected64 = Excel.getdata("Self_instText", 4, 0);
		String actual64 = yourResponse.getText();
		...
		if(actual64.equalsIgnoreCase(expected64)) {
			...
			Excel.wite_data("Self_instText", 4, 1, "Pass");
		}else {
			System.out.println("yourResponse instruction is not matching");
			Excel.wite_data("Self_instText", 4, 1, "fail");
		}
	}
